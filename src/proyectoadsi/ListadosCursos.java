 ...
 * @author Usuario
 */
public class ListadosCursos extends javax.swing.JInternalFrame {
    ...
    public void cargarDocentes(){
        String columnNames[]={"Codigo Curso", "Nombre del Curso", "Codigo Docentes"}; 
        modelo = new DefaultTableModel(null, columnNames); 
        try{
            ResultSet rs = cone.consultaBD("SELECT * FROM Cursos");
            String fila[]= new String[3];
            while (rs.next()){
                fila[0]=rs.getString("codCurso");
                fila[1]=rs.getString("nombCurso");
                fila[2]=rs.getString("codDoc");
            ...
            Logger.getLogger(ListadosCursos.class.getName()).log(Level.SEVERE, null, ex);
        }
 ...
 */
    ...
    /**
     * Creates new form ListadosCursos
     */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            JasperReport report = JasperCompileManager.compileReport("src/Reportes/ListadosCursos.jrxml");
