...
public class EstudianteXcurso extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form EstudianteXcurso
     */
    ConexionBD cone;
    ...
    private void jComboBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox1ItemStateChanged
        try {
            ...
            Logger.getLogger(EstudianteXcurso.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void cargarEstudiantes(){
        ...
        ResultSet rs = cone3.consultaBD("SELECT * FROM Estudiantes, Matriculas WHERE " +
        "estudiantes.Codigo=matriculas.codEst and matriculas.codCurso="+jComboBox1.getSelectedItem());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            JasperReport report = JasperCompileManager.compileReport ("src/Reportes/EstudianteXcursos.jrxml");
            ...
            JasperExportManager.exportReportToPdfFile(print,"Reportes/Especificos/Estudiantes por curso.pdf");
            //toma el archivo y lo convierte en pdf // sino se quiere guardar se quita esta linea
            
            JasperViewer jviewer= new JasperViewer(print,false);
            jviewer.setTitle("Reporte de Estudiantes por Curso");
